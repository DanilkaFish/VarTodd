...
import numpy as np
from scripts.optimization_core.helper import get_matrix, BaseEvaluator, Matrix, ExplorationScore, FinalizationScore
import random
import cma
...
def entrypoint(mat):
    ...
    xopt = run_pso(fun, 18)
    print(xopt)
    x_active = fun.set_up_new_init(0, rank_thr=250, xopt=xopt)
