...
class Evaluator(BaseEvaluator):
    ...
    def policy_mapping(self):
        ...
        self.set_max_pool_size((r_thr, 0), (r_low, 100))
        ...
        self.set_beamsearch_width((r_thr, 0), (2, 6))  
...
def entrypoint():
    ...
    xopt = run_pso(fun, 20)
    x_active = fun.set_up_new_init(0, rank_thr=int(fun.init_rank * 0.80), xopt=xopt)
