...
class Evaluator(BaseEvaluator):
    ...
    def policy_mapping(self):
        ...
        # Make rank schedules problem-aware.
        r1 = int(init_rank * 0.75)
        r2 = int(init_rank * 0.62)
        r_low = max(1, int(init_rank * 0.10))
        ranks = [r1, r2, 0]
        ...
        self.set_max_pool_size((r1, 0), (r_low, 100))
        ...
        self.set_beamsearch_width((int(init_rank * 0.80), 0), (2, 6))  
...
def entrypoint():
    ...
    xopt = run_cma(fun, 60)
    x_active = fun.set_up_new_init(0, rank_thr=int(fun.init_rank * 0.75), xopt=xopt)
