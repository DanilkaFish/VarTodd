...
def run_pso(fun: Evaluator, num_eval: int = 10, particles: int = 5) -> np.ndarray:
...
def run_cma(fun: Evaluator, maxfevals: int = 40, sigma: float = 0.35) -> np.ndarray:
